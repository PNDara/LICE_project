<div class="p-1 flex flex-wrap items-center justify-center">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-slate-100 hover:bg-white hover:scale-105 rounded-lg max-w-xs shadow-lg">
        ...
        <div class="relative pt-10 px-10 flex items-center justify-center">
            ...
            <img class="relative w-40" src="../uploads/images/book-grade-6.jpg" alt="">
        </div>
        <div class="relative text-amber-500 px-6 pb-6 mt-6">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-slate-100 hover:bg-white hover:scale-105 rounded-lg max-w-xs shadow-lg">
        ...
        <div class="relative pt-10 px-10 flex items-center justify-center">
            ...
            <img class="relative w-40" src="../uploads/images/book-grade-5.jpg" alt="">
        </div>
        <div class="relative text-amber-500 px-6 pb-6 mt-6">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-slate-100 hover:bg-white hover:scale-105 rounded-lg max-w-xs shadow-lg">
        ...
        <div class="relative pt-10 px-10 flex items-center justify-center">
            ...
            <img class="relative w-40" src="../uploads/images/book-grade-3.jpg" alt="">
        </div>
        <div class="relative text-amber-500 px-6 pb-6 mt-6">
            <span class="block opacity-75 -mb-1">Outdoor</span>
            <div class="flex justify-between">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-slate-100 hover:bg-white hover:scale-105 rounded-lg max-w-xs shadow-lg">
        ...
        <div class="relative pt-10 px-10 flex items-center justify-center">
            ...
            <img class="relative w-40" src="../uploads/images/book-grade-4.jpg" alt="">
        </div>
        <div class="relative text-amber-500 px-6 pb-6 mt-6">
            <span class="block opacity-75 -mb-1">Outdoor</span>
            <div class="flex justify-between">
    ...
    <div class="flex-shrink-0 m-6 relative overflow-hidden bg-slate-100 hover:bg-white hover:scale-105 rounded-lg max-w-xs shadow-lg">
        ...
        <div class="relative pt-10 px-10 flex items-center justify-center">
            ...
            <img class="relative w-40" src="../uploads/images/book-grade-1.jpg" alt="">
        </div>
        <div class="relative text-amber-500 px-6 pb-6 mt-6">
            <span class="block opacity-75 -mb-1">Outdoor</span>
            <div class="flex justify-between">
